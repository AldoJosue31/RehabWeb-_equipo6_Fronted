  ...
  template: `
    <section class="rw-page">
      <header class="rw-page-header">
        <div>
          <h1 class="rw-title">Alertas de Inactividad</h1>
          <p class="rw-subtitle">Alertas derivadas del estado real de los pacientes.</p>
        </div>
      </header>
      ...
      @if (loading()) {
        ...
        <div class="grid gap-4">
          @for (patient of inactivePatients(); track patient.id) {
            <article class="rw-card grid gap-4 p-4 md:grid-cols-[1fr_auto] md:items-center">
              <div>
